      ...
      if (item.id === itemId) {
        ...
        if (field === 'itemId') {
          ...
          if (product) {
            ...
            // If selecting from bill items, we'll have these properties
                            ...
                            >
                              ...
                              <SelectContent>
                                {productsLoading ? (
                                  ...
                                  // Filter products to show only what was purchased if vendor selected and history exists
                                  (billItems.length > 0 ? products.filter(p => billItems.some(bi => bi.itemId === p.id)) : products).map((product) => (
